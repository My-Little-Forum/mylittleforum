...
/*@cc_on!@*/
false&&!(document.documentMode&&document.documentMode>=8);var imageCanvas=document.getElementById("image-canvas")||document.createElementWithAttributes("div",[["id","image-canvas"]],body);imageCanvas.setVisible=function(enable){this.style.display=enable?"block":"none"};var stopTrigger=function(){if(hashTrigger){window.clearInterval(hashTrigger);var scrollPos=document.getScrollPosition();if(!isIELower8){window.history.back()}else{window.location.hash="GET_OPERA"}window.scrollTo(scrollPos.left,scrollPos.top)}};var oldOnKeyPressFunc=window.document.onkeypress;window.document.onkeypress=function(e){var keyCode=document.getKeyCode(e);if(keyCode==27){imageCanvas.setVisible(false);stopTrigger()}if(typeof oldOnKeyPressFunc=="function"){oldOnKeyPressFunc(e)}};imageCanvas.onclick=function(e){imageCanvas.setVisible(false);stopTrigger()};imageCanvas.setVisible(false);var fullSizeImage=document.getElementById("fullSizeImage")||document.createElementWithAttributes("img",[["id","fullSizeImage"]],imageCanvas);for(var i=0;i<els.length;i++){var links=els[i].getElementsByTagName("a");for(var j=0;j<links.length;j++){if(links[j].rel.search(/thumbnail/)!=-1){links[j].onclick=function(e){window.location.hash="image";var currentHash=window.location.hash;fullSizeImage.src=this.href;imageCanvas.setVisible(true);var imgPoSi=document.getElementPoSi(fullSizeImage);var scrollPos=document.getScrollPosition();var winSize=document.getWindowSize();imageCanvas.style.height=winSize.pageHeight+"px";fullSizeImage.style.left=((winSize.windowWidth-imgPoSi.width)/2)+"px";fullSizeImage.style.top=(scrollPos.top+(winSize.windowHeight-imgPoSi.height)/15)+"px";hashTrigger=window.setInterval(function(){if(this.location.hash!=currentHash){imageCanvas.setVisible(false)}},50);return false}}}}}function AjaxPreviewWindow(c,n){var n=n?n:"";var e=false;var h=document.getElementById("ajax-preview");var o=this;if(!h){h=document.createElementWithAttributes("div",[["id","ajax-preview"]],null);h.style.display="none";document.body.appendChild(h)}h.innerHTML=c.stripslashes().trim();var j=null;var l=0;var f=document.getElementById("ajax-preview-close");var b=document.getElementById("ajax-preview-content");var m=document.getElementById("ajax-preview-main");if(!f||!b||!m){window.alert("AjaxPreviewWindow kann nicht erzeugt werden!")}var i=window.document.onmousedown;window.document.onmousedown=function(p){o.closeByOutSideClick(p);if(typeof i=="function"){i(p)}};var k=window.document.onkeypress;window.document.onkeypress=function(q){var p=document.getKeyCode(q);if(p==27){o.setVisible(false)}if(typeof k=="function"){k(q)}};f.onclick=function(){o.setVisible(false);return false};var a=document.createElementWithAttributes("img",[["id","ajax-preview-throbber"],["src",n+settings.ajax_preview_throbber_image],["alt","[*]"]],b);var g=document.createElementWithAttributes("p",[["id","ajax-preview-replylink-wrapper"]],b);var d=document.createElementWithAttributes("a",[["id","ajax-preview-replylink"],["href","#"]],null);d.appendChild(document.createTextNode(lang.reply_link));g.style.display="none";this.closeByOutSideClick=function(u){var y=document.getElementById("image-canvas");if(o.isVisible()&&y&&y.style.display=="none"){var s=document.getTarget(u);if(s&&s!=o.getOpener().firstChild){var r=document.getMousePos(u);var q=r.left;var p=r.top;var x=o.getDocumentPosition().left;var w=o.getDocumentPosition().top;var t=o.getWidth();var v=o.getHeight();if((q<x||q>(x+t)||p<w||p>(w+v))&&s.className!="ap"){o.setVisible(false)}}}};this.hideURI=function(p){e=p};this.setPosition=function(q,s){h.style.left=q+"px";h.style.top=s+"px";var r=this.getWidth();var p=document.getWindowSize().windowWidth;if((q+r)>=p){this.moveHorizontal(p-25-(q+r))}else{this.moveHorizontal(0)}};this.getWidth=function(){return m.offsetWidth};this.getHeight=function(){return h.offsetHeight+m.offsetHeight};this.setOpener=function(p){j=p};this.getOpener=function(){return j};this.isVisible=function(){return h.style.display!="none"};this.getDocumentPosition=function(){var q=h.offsetLeft;var p=h.offsetTop;return{top:p,left:q+l}};this.moveHorizontal=function(p){l=p;m.style.left=p+"px"};this.setVisible=function(p){if(p){h.style.display="block"}else{h.style.display="none"}};this.setText=function(p){b.innerHTML=p;if(p!=""){if(!d.firstChild){d.appendChild(document.createTextNode(lang.reply_link))}if(!e){g.appendChild(d);b.appendChild(g)}new FullSizeImage(b)}else{b.appendChild(a)}};this.setURI=function(p){if(!p){d.href="#";g.style.display="none"}else{g.style.display="block";d.href=p}}}function MyLittleJavaScript(){var r=null;var j=null;var i=null;var t="index.php";var p=[];var b=[];var g=new RegExp(/[?|&]id=([0-9]+)(#p([0-9]+))?/);var l=this;var e=function(u){if(u&&g.test(u.href)){var v=g.exec(u.href);return v[3]?v[3]:v[1]}return false};this.getTemplatePath=function(){if(r!=null){return r}var v=document.getElementsByTagName("link");for(var u=0;u<v.length;u++){if(v[u].rel=="stylesheet"){return v[u].href.substring(0,v[u].href.lastIndexOf("/")+1)}}return""};var n=function(w){var v=document.createElementWithAttributes("a",[["pid",w],["title",lang.ajax_preview_title],["href",t+"?id="+w],["onclick",function(x){l.showAjaxPreviewWindow(this);this.blur();return false}]],null);var u=document.createElementWithAttributes("img",[["src",r+settings.ajax_preview_image],["title",lang.ajax_preview_title],["alt",""],["onload",function(x){this.alt="[…]"}],["onerror",function(x){this.alt="[…]"}]],v);return v};var f=function(v){if(!v||!j){return}var u=e(v);if(u&&v.parentNode){v.parentNode.appendChild(document.createTextNode(String.fromCharCode(160)));v.parentNode.appendChild(n(u))}};var c=function(v){if(!v||!j){return}j.hideURI(true);var w=document.getElementById("postingform");var u=false;if(w&&w.elements.id){u=parseInt(w.elements.id.value)}if(u){v.appendChild(document.createTextNode(String.fromCharCode(160)));v.appendChild(n(u))}};this.selectPosting=function(v,u){var w=u&&typeof u=="object"&&u.length>0;var z=w?u[0]:v;var y=w?v:false;var x=null;if(!z||!(x=document.getElementById("markimg_"+z))){return}x.src=r+settings.mark_process_image;x.alt="[ ]";var A=[new Query("mode","posting"),new Query("mark",z),new Query("method","ajax")];if(!w){new Request(t,"POST",A,this,"selectPosting",z,true)}else{if(w&&y&&document.getElementById("marklink_"+z)){var B=document.getElementById("marklink_"+z);var C=y.getElementsByTagName("action")&&y.getElementsByTagName("action")[0].firstChild.data=="1";if(C){x.src=r+settings.marked_image;x.alt="[●]";B.title=lang.unmark_linktitle;x.title=lang.unmark_linktitle}else{x.src=r+settings.unmarked_image;x.alt="[○]";B.title=lang.mark_linktitle;x.title=lang.mark_linktitle}}}};var h=function(w){w=w||false;for(var v=0;v<p.length;v++){p[v].setFold(!w,true)}var u=[new Query("fold_threads",w),new Query("ajax","true")];new Request(t,"GET",u)};var s=function(){if(!document.getElementById("subnavmenu")){return}var w=document.getElementById("subnavmenu").getElementsByTagName("a");var x=null;var z=new RegExp(/fold-([0-9])+/);for(var v=0;v<w.length;v++){if(w[v].className.search(z)!=-1){x=w[v];break}}if(x){var y=z.exec(x.className);var u=y.length>1&&y[1]=="1";x.onclick=function(A){h(!u);this.className=this.className.replace(z,"fold-"+(u?2:1));this.firstChild.replaceData(0,this.firstChild.nodeValue.length,(u?lang.expand_threads:lang.fold_threads));this.title=u?lang.expand_threads_linktitle:lang.fold_threads_linktitle;u=!u;this.blur();return false}}};var o=function(y){if(!y){return}s();for(var A=0;A<y.length;A++){var u=y[A];var D=u.parentNode;var x=document.getFirstChildByElement(D,"a",["ap","reply","thread","replynew","threadnew","thread-sticky","threadnew-sticky","reply-search","thread-search"]);var B=parseInt(u.id.substring(1));if(!B){continue}var E=u.getElementsByTagName("a");if(E.length>=2){for(var z=0;z<E.length;z++){if(E[z].href.search(/mark/)!=-1){E[z].pid=B;E[z].onclick=function(F){l.selectPosting(this.pid);this.blur();return false}}else{if(E[z].href.search(/delete_posting/)!=-1){E[z].onclick=function(F){var G=window.confirm(lang.delete_posting_confirm);if(G){this.href+="&delete_posting_confirm=true"}this.blur();return G}}}}}if(x&&j){if(E.length>=1){var C=E[0];u.insertBefore(n(B),C);u.insertBefore(document.createTextNode(String.fromCharCode(160)),C)}else{u.appendChild(document.createTextNode(String.fromCharCode(160)));u.appendChild(n(B))}}if(D.parentNode.className.search(/thread/)!=-1&&D.parentNode.className.search(/[folded|expanded]/)!=-1){p.push(new Thread(D.parentNode,r))}}var w=document.getElementsByClassName("options");if(w.length>0){for(var A=0;A<w.length;A++){var E=w[A].getElementsByTagName("a");if(E.length>0){for(var z=0;z<E.length;z++){if(E[z].href.search(/delete_posting/)!=-1){E[z].onclick=function(F){var G=window.confirm(lang.delete_posting_confirm);if(G){this.href+="&delete_posting_confirm=true"}return G};break}}}}}var v=document.getElementsByClassName("posting");v=v.length>0?v:document.getElementsByClassName("thread-posting");new FullSizeImage(v)};var q=function(w){var u=document.getElementById(w);if(!u){return}var v=(u.alt)?u.alt:u.value;u.onfocus=function(x){if(this.value==v){this.value=""}};u.onblur=function(x){if(this.value.trim()==""){this.value=v}}};var d=function(){if(document.getElementById("content")){var v=document.getElementById("content").getElementsByTagName("form");if(v&&v.length>0){for(var u=0;u<v[0].elements.length;u++){if(v[0].elements[u].type=="text"&&v[0].elements[u].name!="search_user"&&v[0].elements[u].name!="smiley_code"&&v[0].elements[u].name!="new_category"){v[0].elements[u].focus();break}}}}};var a=function(v){v=v||false;for(var u=0;u<b.length;u++){b[u].setFold(!v)}};var k=function(x){if(!x){return}for(var w=0;w<x.length;w++){var y=x[w];var v=parseInt(y.id.substring(1));if(!v){continue}b.push(new Posting(v))}var A=null;if(b.length==0||!(A=document.getElementById("subnavmenu"))){return}var u=document.createElementWithAttributes("li",[],A);var z=document.createElementWithAttributes("a",[["isExpand",true],["title",lang.fold_postings_title],["href","#"],["className","fold-postings"]],u);z.appendChild(document.createTextNode(lang.fold_postings));z.onclick=function(B){this.isExpand=!this.isExpand;a(this.isExpand);this.blur();return false}};var m=function(){var z=[[document.getElementById("terms_of_use")||false,settings.terms_of_use_popup_width,settings.terms_of_use_popup_height],[document.getElementById("edit_avatar")||false,settings.avatar_popup_width,settings.avatar_popup_height]];for(var y=0;y<z.length;y++){if(z[y][0]){var B=document.getWindowSize();var v=z[y][1];var A=z[y][2];var u=parseInt(0.5*(B.windowWidth-v));var x=parseInt(0.25*(B.windowHeight-A));z[y][0].onclick=function(w){window.open(this.href,"MyLittleForum","width="+v+",height="+A+",left="+u+",top="+x+",scrollbars,resizable");return false}}}};this.updateAjaxPreviewWindow=function(u){if(u===false||!j){return}var v=u.getElementsByTagName("content");var w=u.getElementsByTagName("locked");w=!w?true:w[0].firstChild.data=="1";v=!v?"":v[0].firstChild.data;if(w){j.setURI(false)}else{j.setURI("index.php?mode=posting&id="+j.getOpener().pid)}if(v.trim()==""){v="<p>"+lang.no_text+"</p>"}j.setText(v)};this.showAjaxPreviewWindow=function(w){if(!w||!j){return}if(w==j.getOpener()&&j.isVisible()){j.setVisible(false);j.setOpener(null)}else{var v=document.getElementPoSi(w);j.setOpener(w);j.setText("");j.setVisible(true);j.setPosition(v.left,v.top);var u=[new Query("mode","entry"),new Query("ajax_preview","true"),new Query("id",w.pid)];new Request(t,"POST",u,this,"updateAjaxPreviewWindow",null,true)}};this.getAjaxPreviewWindow=function(){return j};this.init=function(u){u=u||false;d();q("search-input");q("search-user");r=this.getTemplatePath();if(u){j=new AjaxPreviewWindow(u,r)}f(document.getElementById("user-last-posting"));c(document.getElementById("reply-to"));o(document.getElementsByClassName("tail"));k(document.getElementsByClassName("thread-posting"));m();i=new Sidebar(r);if(typeof preload=="object"){document.preloadImages(preload,r)}}}var mlf=null;window.ready.push(function(){mlf=new MyLittleJavaScript();var a=typeof settings.ajaxPreviewStructure=="string"?settings.ajaxPreviewStructure:false;if(mlf&&typeof lang=="object"){mlf.init(a)}});