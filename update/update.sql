...
CREATE TABLE mlf2_read_entries (id bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, user_id int(11) UNSIGNED NOT NULL, e_id int(11) UNSIGNED NOT NULL, time timestamp NOT NULL, PRIMARY KEY (id), UNIQUE KEY read_per_user (user_id, e_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
