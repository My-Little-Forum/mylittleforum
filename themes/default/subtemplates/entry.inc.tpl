...
{if $options.release}<li><a href="index.php?mode=posting&amp;release_posting={$id}&amp;csrf_token={$CSRF_TOKEN}&amp;back=entry" class="release" title="{#release_message_linktitle#}">{#release_message_linkname#}</a></li>{/if}
