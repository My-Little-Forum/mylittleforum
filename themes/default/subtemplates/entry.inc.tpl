...
<div class="reply">{if $locked==0}<a class="stronglink" href="index.php?mode=posting&amp;id={$id}&amp;back=entry" title="{#reply_link_title#}">{#reply_link#}</a>{else}<span class="locked"><img class="icon" src="{$FORUM_ADDRESS}/{$THEMES_DIR}/{$theme}/images/general-lock-closed.svg" alt="" width="13" height="13"/><span>{#posting_locked#}</span></span>{/if}</div>
...
{if $options.edit}<li><a href="index.php?mode=posting&amp;edit={$id}&amp;back=entry" title="{#edit_message_linktitle#}"><img class="icon" src="{$FORUM_ADDRESS}/{$THEMES_DIR}/{$theme}/images/file-edit.svg" alt="" width="13" height="13"/><span>{#edit_message_linkname#}</span></a></li>{/if}
...
{if $options.move}<li><a href="index.php?mode=posting&amp;move_posting={$id}&amp;back=entry" title="{#move_posting_linktitle#}"><img class="icon" src="{$FORUM_ADDRESS}/{$THEMES_DIR}/{$theme}/images/{if #dir# == 'rtl'}arrow-move-rtl.svg{else}arrow-move-ltr.svg{/if}" alt="" width="13" height="13"/><span>{#move_posting_linkname#}</span></a></li>{/if}
