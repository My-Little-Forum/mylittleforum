...
<input id="not_public" type="radio" name="user_area_access" value="1"{if $edSet.user_area_access==1} checked="checked"{/if} /><label for="not_public">{#accessible_reg_users_only#}</label><br />
<input id="not_public" type="radio" name="user_area_access" value="0"{if $edSet.user_area_access==0} checked="checked"{/if} /><label for="not_public">{#accessible_team_users_only#}</label></td>
</tr>
<tr>
