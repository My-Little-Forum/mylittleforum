...
{/if}
<div class="thread-posting{if $element.new} new{/if}" id="p{$element.id}">
<div class="header">
...
<h{if $element.pid==0}1{else}2{/if} id="headline-{$element.id}" onmouseover="this.style.color='#000080'" onmouseout="this.style.color='#000'">{$element.subject}{if $element.pid==0 && $category_name} <span class="category">({$category_name})</span>{/if}</h{if $element.pid==0}1{else}2{/if}>
