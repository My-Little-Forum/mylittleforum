...
{if $element.options.edit}<li><a href="index.php?mode=posting&amp;edit={$element.id}&amp;back=thread" title="{#edit_message_linktitle#}"><img class="icon" src="{$FORUM_ADDRESS}/{$THEMES_DIR}/{$theme}/images/file-edit.svg" alt="" width="13" height="13"/><span>{#edit_message_linkname#}</span></a></li>{/if}
...
{if $element.options.move}<li><a href="index.php?mode=posting&amp;move_posting={$element.id}&amp;back=thread" title="{#move_posting_linktitle#}"><img class="icon" src="{$FORUM_ADDRESS}/{$THEMES_DIR}/{$theme}/images/{if #dir# == 'rtl'}arrow-move-rtl.svg{else}arrow-move-ltr.svg{/if}" alt="" width="13" height="13"/><span>{#move_posting_linkname#}</span></a></li>{/if}
