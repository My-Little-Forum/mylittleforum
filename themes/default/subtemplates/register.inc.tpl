...
<input id="new_user_name" class="login" type="text" size="25" name="new_user_name" value="{$new_user_name|default:''}" maxlength="{$settings.username_maxlength}" /></p>
<p><label for="new_user_email" class="main">{#register_user_email#}</label><br />
<input id="new_user_email" class="login" type="text" size="25" name="new_user_email" value="{$new_user_email|default:''}" maxlength="{$settings.email_maxlength}" /></p>
<p><label for="reg_pw" class="main">{#register_pw#}</label><br />
<input id="reg_pw" class="login" type="password" size="25" name="reg_pw" maxlength="255" /></p>
<p><label for="reg_pw_conf" class="main">{#register_pw_conf#}</label><br />
<input id="reg_pw_conf" class="login" type="password" size="25" name="reg_pw_conf" maxlength="255" /></p>
