...
{if $data.$element.options.edit}<li><a href="index.php?mode=posting&amp;edit={$data.$element.id}&amp;back=thread" title="{#edit_message_linktitle#}"><img class="icon" src="{$FORUM_ADDRESS}/{$THEMES_DIR}/{$theme}/images/file-edit.svg" alt="" width="13" height="13"/><span>{#edit_message_linkname#}</span></a></li>{/if}
