...
{if $data.$element.options.release}<li><a href="index.php?mode=posting&amp;release_posting={$data.element.id}&amp;back=thread" class="release" title="{#release_message_linktitle#}">{#release_message_linkname#}</a></li>{/if}
