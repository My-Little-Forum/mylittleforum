...
{/if}
{/if}
<p><input type="submit" name="message_submit" value="{#message_submit_caption#}" size="50" onclick="document.getElementById('throbber-submit').style.display = 'inline'" /> <img id="throbber-submit" style="display:none;" src="{$THEMES_DIR}/{$theme}/images/throbber_submit.gif" alt="" width="16" height="16" /></p>
</div>
</form>
{/if}
