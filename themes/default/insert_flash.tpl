...
function insert_bbcode()
 {
  var flash_code = document.getElementById('flash_code').value;
  var flash_url = document.getElementById('flash_url').value;
  var flash_width = document.getElementById('flash_width').value;
  var flash_height = document.getElementById('flash_height').value;
  if(flash_code!='')
   {
    ...
    opener.insert('text','[flash width='+flash_width+' height='+flash_height+']'+flash_url+'[/flash]');
   }
  else if(flash_url!='')
   {
    opener.insert('text','[flash width='+flash_width+' height='+flash_height+']'+flash_url+'[/flash]');
...
<p><input class="format-button" type="button" value="{#insert_flash_button#}" onclick="insert_bbcode()" /></p>
